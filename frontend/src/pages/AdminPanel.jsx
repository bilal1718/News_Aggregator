                  ...
                  <div className="px-4 py-5 sm:px-6 hover:bg-gray-50">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex space-x-2">
                        ...
                        {report.status === 'reviewed' && (
                          <span className="inline-flex items-center px-3 py-1.5 text-xs font-medium rounded-md bg-yellow-100 text-yellow-800">
                            Reviewed
                          </span>
                        )}
                      </div>
                    ...
                    <div className="mt-2 sm:flex sm:justify-between">
                      ...
                      <div className="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                        <p>
                          Reported by: {report.reporter?.name || 'Anonymous'} • {formatDate(report.created_at)}
                        </p>
                      </div>
                    </div>
