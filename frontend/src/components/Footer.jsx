            ...
            <form className="mt-6" onSubmit={handleSubscribe}>
              ...
              <div className="mt-2 flex rounded-md shadow-sm">
                <input 
                  ...
                  className="focus:ring-blue-500 focus:border-blue-500 block w-full rounded-l-md sm:text-sm border-gray-700 bg-gray-700 text-white px-4 py-2"
                  value={email}
              ...
              {subscriptionStatus.message && (
                <p className={`mt-2 text-sm ${subscriptionStatus.error ? 'text-red-400' : 'text-green-400'}`}>
                  {subscriptionStatus.message}
                </p>
              )}
            </form>
